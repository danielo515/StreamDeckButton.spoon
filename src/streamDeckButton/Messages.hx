...
@:native('messages')
class Messages {
  static public function parseMessage(message:String):Either< String, IncomingMessage > {
  ...
  static public function getTitleMessage(context:String, title:String) {
    return t({
      event: "setTitle",
      context: context,
      payload: t({
  ...
  static public function showOkMessage(context) {
    return t({
      event: "showOk",
      context: context
    });
  ...
  **/
  static public function getImageMessage(context:String, imagePath:String):Null< Dynamic > {
